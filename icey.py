...
mouth_normal = c.create_line(180,250,200,260,220,250, smooth=1 , width=2 ,state=HIDDEN)
mouth_happy = c.create_line(170,250,200,282,230,250,smooth=1 , width=2 , state=HIDDEN)
mouth_sad = c.create_line(170,250,200,230,230,250,smooth=1 , width=2 , state=NORMAL)
